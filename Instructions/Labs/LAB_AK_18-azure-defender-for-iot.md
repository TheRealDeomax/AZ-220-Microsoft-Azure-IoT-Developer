---
lab:
    title: 'Lab 18: Get started with Microsoft Defender for IoT'
...
> **TIP**: **Microsoft Defender for IoT** was previously referred to as **Azure Defender for IoT** and **Azure Security Center for IoT**. You may find some inconsistencies in the online documentation, GitHub resources and in this content due to the phased rollout of the name change.
...
* Review the alert in the Microsoft Defender for IoT
...
### Exercise 2: Enable Microsoft Defender for IoT Hub

Microsoft Defender for IoT enables you to unify security management and enable end-to-end threat detection and analysis across hybrid cloud workloads and your Azure IoT solution.

Microsoft Defender for IoT is composed of the following components:
...
In this task, you will enable **Microsoft Defender for IoT** for your IoT Hub.
...
1. On the left-side menu, under **Defender for IoT**, click **Overview**.
    ...
    Microsoft Defender for IoT Hub will onboard the first time a Security pane is opened.
...
1. Take a moment to review the contents on the Security Overview pane.
    ...
    > **Note**: Threats are not instantly detected the first moment that you onboard Microsoft Defender for IoT, you will begin to see threat detections reported on this Overview pane before the end of this lab.

#### Task 2: Log Analytics creation

When Microsoft Defender for IoT is turned on, an Azure Log Analytics workspace should be created to store raw security events, alerts, and recommendations for your IoT devices, IoT Edge, and IoT Hub.
...
Microsoft Defender for IoT offers full integration with your existing IoT device management platform, enabling you to manage your device security status as well as make use of existing device control capabilities.

Microsoft Defender for IoT makes use of the module twin mechanism and maintains a security module twin named azureiotsecurity for each of your devices. The security module twin holds all the information relevant to device security for each of your devices. To make full use of Microsoft Defender for IoT features, you will need to create, configure, and use these security module twins for your new IoT Edge device.
...
### Exercise 5: Deploy Microsoft Defender for IoT C# Security Agent

Microsoft Defender for IoT provides a reference architecture for security agents that log, process, aggregate, and send security data through IoT Hub. There are C and C# based agents. C agents are recommended for devices with more restricted or minimal device resources.

Security agents support the following features:

* Collect raw security events from the underlying Operating System (Linux, Windows). To read more about available security data collectors, see Microsoft Defender for IoT agent configuration.
...
* Configure remotely through use of the **azureiotsecurity** module twin. To read more, see Configure an Microsoft Defender for IoT agent.
...
1. At the Cloud Shell command prompt, to reconnect to your virtual machine, enter the SSH command you used earlier.
    ...
    Your Microsoft Defender for IoT Agent should now be active and running.

1. At the Cloud Shell command prompt, to check the deployment status of the Microsoft Defender for IoT Agent, enter the following command.
...
Now that your Microsoft Defender for IoT device agents are installed on your device, the agents will be able to collect, aggregate and analyze raw security events from your device.

### Exercise 6: Configure Solution Management

Microsoft Defender for IoT provides end-to-end security for Azure-based IoT solutions.

With Microsoft Defender for IoT, you can monitor your entire IoT solution in one dashboard, surfacing all of your IoT devices, IoT platforms and back-end resources in Azure.

Once enabled on your IoT Hub, Microsoft Defender for IoT automatically identifies other Azure services, also connected to your IoT Hub and related to your IoT solution.
...
1. To view the list of resources, click **Monitored Resources**.
    ...
    Note that the list of resources already includes your IoT Hub, the workspace that was created when Microsoft Defender for IoT was activated earlier as well as the current subscription.
...
After defining all of the resource relationships, Microsoft Defender for IoT leverages Azure Defender to provide you security recommendations and alerts for these resources.

#### Task 2: View Microsoft Defender for IoT in Action

You now have your the security agent installed on your device and your solution configured. It is a good time to check out the different views for Microsoft Defender for IoT.
...
### Exercise 9: Review Microsoft Defender for IoT Alerts
...
#### Task 1: Review the Microsoft Defender for IoT Dashboard
